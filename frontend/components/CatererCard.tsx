...
export default function CatererCard({ caterer }: CatererCardProps) {
  return (
    <article className=" border border-slate-200 bg-white p-6 shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-md">
      <div className="flex flex-col gap-3">
        <div className="flex items-start justify-between gap-4">
          ...
          <span className=" bg-slate-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-slate-600">
        ...
        <div className="flex items-center justify-between bg-slate-50 px-4 py-3 text-sm text-slate-700">
          ...
          <span className=" bg-slate-100 px-3 py-1 text-slate-700">
